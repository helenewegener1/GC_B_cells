...
samples_dict = {
  ...
  # "HH117_clone_nr_3_clone_1849_1":  "CD: 3. largest GC B cell clone",
  ...
  # "HH119_clone_nr_3_clone_28075_1": "CRC: 3. largest GC B cell clone",
...
for sample, sample_name in samples_dict.items():
  ...
  def plot_tree(tree, df_meta, var, sample, custom_plot_path, color_list, counts_dir=None):
      ...
      tree.render(svg_path, colormap=colormap, scale=10, branch_margin=20)
      cairosvg.svg2png(url=svg_path, write_to=png_path, dpi=150)
