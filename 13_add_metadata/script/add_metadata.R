...
ggsave("13_add_metadata/plot/00_N_cells_celltypes.png", width = 12, height = 7)
...
for (sample_name in sample_names){
  ...
  ggsave(glue("13_add_metadata/plot/{sample_name}.png"), width = 8, height = 8)
...
saveRDS(seurat_obj_prepped_list, "13_add_metadata/out/seurat_obj_prepped_list.rds")
