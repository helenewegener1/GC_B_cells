...
mixcr findShmTrees \
  -f \
  --report ${OUT_DIR}/findShmTrees.report.txt \
  --export-trees ${OUT_DIR}/shm_trees.tsv \
  --export-trees-with-nodes ${OUT_DIR}/shm_trees_nodes.tsv \
  ${OUT_DIR}/*.contigs.reassigned.clns
