...
ggsave(glue("46_sequence_driven_clustering/plot/ligth_chain/{HH}_{top_clones}_clone_ID_fan.png"), width = 9, height = 6.5, dpi = 1000)
...
ggsave(glue("46_sequence_driven_clustering/plot/ligth_chain/{HH}_{top_clones}_v_gene_clade.png"), width = 9, height = 6.5, dpi = 1000)
...
ggsave(glue("46_sequence_driven_clustering/plot/ligth_chain/{HH}_{top_clones}_locus.png"), width = 9, height = 6.5, dpi = 1000)
...
ggsave(glue("46_sequence_driven_clustering/plot/ligth_chain/{HH}_{top_clones}_j_call.png"), width = 9, height = 6.5, dpi = 1000)
...
ggsave(glue("46_sequence_driven_clustering/plot/ligth_chain/{HH}_{top_clones}_j_gene.png"), width = 9, height = 6.5, dpi = 1000)
...
#   labs(title = glue("{HH} H clone {top_clones}"))
# 
# ggsave(glue("46_sequence_driven_clustering/plot/ligth_chain/{HH}_{top_clones}_v_call.png"), width = 18, height = 16, dpi = 1000)
...
ggsave(glue("46_sequence_driven_clustering/plot/ligth_chain/{HH}_{top_clones}_v_j_junction.png"), width = 9, height = 6.5, dpi = 1000)
...
ggsave(glue("46_sequence_driven_clustering/plot/ligth_chain/{HH}_{top_clones}_v_gene.png"), width = 9, height = 6.5, dpi = 1000)
