...
WD="/home/people/helweg/ciir/people/helweg/projects/GC_B_cells/05_run_cellranger/out_v8"
...
# Submit with:  qsub -v PATIENT=HH117 run_cellranger_v8.sh          (one patient)
#           or  qsub -v PATIENT=HH117,HH151 run_cellranger_v8.sh    (several, comma-separated, no spaces)
