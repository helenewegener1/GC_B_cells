...
outdir_plot <- glue("30_seurat_integration/plot/plot_{n_dim}PCs")
...
saveRDS(seurat_integrated, glue("30_seurat_integration/out/seurat_integrated_{n_dim}PCs.rds"))
...
# Reductions(obj_tmp)
# 
# filename <- glue("31_seurat_integration/out/mydata_RNA_v5.h5Seurat")
