...
#PBS -e /home/projects/dtu_00062/people/helweg/projects/GC_B_cells/45_immcantation/script/run_changeo.err
#PBS -o /home/projects/dtu_00062/people/helweg/projects/GC_B_cells/45_immcantation/script/run_changeo.log
#PBS -N run_changeo
...
while IFS= read -r SAMPLE_NAME; do
    ./02_changeo.sh "$SAMPLE_NAME"
done < <(ls /home/projects/dtu_00062/people/helweg/projects/GC_B_cells/05_run_cellranger/out_v9/ | sed 's/^res_//')
